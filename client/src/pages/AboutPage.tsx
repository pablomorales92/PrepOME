    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="prose max-w-none">
        ...
        <ul className="list-disc pl-5 text-muted-foreground space-y-2 mb-6">
          <li><strong>Fase Local:</strong> Realizada en cada centro educativo, permite la selección inicial de los participantes.</li>
          <li><strong>Fase Autonómica:</strong> Los clasificados localmente compiten a nivel de comunidad autónoma.</li>
          <li><strong>Fase Nacional:</strong> Reúne a los mejores estudiantes de cada comunidad autónoma.</li>
          <li><strong>Fase Internacional:</strong> Los ganadores nacionales representan a España en la Olimpiada Internacional de Matemáticas (IMO).</li>
        </ul>
        ...
        <h2 className="font-heading font-bold text-2xl text-foreground mt-8 mb-4">Objetivos</h2>
        <ul className="list-disc pl-5 text-muted-foreground space-y-2 mb-6">
          <li>Estimular y promover el estudio de las matemáticas entre los jóvenes.</li>
          <li>Contribuir a la difusión de la cultura matemática.</li>
          <li>Proporcionar contextos estimulantes para los alumnos con mayor talento e interés por las matemáticas.</li>
          <li>Seleccionar y preparar a estudiantes para representar a España en competiciones internacionales.</li>
        </ul>
        ...
        <h2 className="font-heading font-bold text-2xl text-foreground mt-8 mb-4">Beneficios de participar</h2>
        <ul className="list-disc pl-5 text-muted-foreground space-y-2 mb-6">
