        ...
        <div className="container mx-auto max-w-4xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <HashLink to="/PrepOME/644e064fd4181786a7db0846f06a3682/que-es" className="inline-block mt-4 text-primary font-semibold hover:underline">Leer más →</HashLink>
            </div>
            <div>
              ...
              <HashLink to="/PrepOME/644e064fd4181786a7db0846f06a3682/que-es" className="inline-block mt-4 text-primary font-semibold hover:underline">Ver todos los beneficios →</HashLink>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-muted py-16 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-card rounded-lg shadow-md overflow-hidden">
              ...
              <div className="p-6">
                ...
                <HashLink to="/PrepOME/644e064fd4181786a7db0846f06a3682/calendario" className="inline-block mt-2 text-primary font-semibold text-sm hover:underline">Más información</HashLink>
              </div>
            </div>
          ...
          <div className="text-center mt-10">
            <HashLink to="/PrepOME/644e064fd4181786a7db0846f06a3682/calendario" className="bg-primary hover:bg-primary/80 text-primary-foreground font-bold py-3 px-6 rounded-lg transition-colors duration-200 shadow-md">
